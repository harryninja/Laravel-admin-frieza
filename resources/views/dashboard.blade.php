      ...
      <div class="col-md-6 col-xl-4">
        <div class="block block-rounded h-100 mb-0">
          ...
          <div class="block-content">
            <p>
             you can start working on your Laravel project as soon as possible! Frieza's aemy assets are integrated and work seamlessly with Laravel Vite, so you can use the npm scripts as you would in any other Laravel project.
            </p>
            <p>
