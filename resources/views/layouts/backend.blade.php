...
<head>
  ...
  <!-- Modules -->
  @yield('css')
  @vite(['resources/sass/main.scss', 'resources/js/frieza-modules/app.js'])

  <!-- Alternatively, you can also include a specific color theme after the main stylesheet to alter the default color theme of the template -->
  {{-- @vite(['resources/sass/main.scss', 'resources/sass/frieza-customs/themes/xwork.scss', 'resources/js/frieza-modules/app.js']) --}}
  @yield('js')
</head>
        ...
        <div class="content-header bg-white-5">
          ...
          <a class="fw-semibold text-white tracking-wide" href="/">
            ...
            <span class="smini-hidden">
              Frieza<span class="opacity-75">army</span>
            </span>
          </a>
          <!-- END Logo -->
          ...
          <div>
            ...
            <button type="button" class="btn btn-sm btn-alt-secondary" data-toggle="class-toggle" data-target="#sidebar-style-toggler" data-class="fa-toggle-off fa-toggle-on" onclick="FriezaArmy.layout('sidebar_style_toggle');FriezaArmy.layout('header_style_toggle');">
            ...
            <!-- Dark Mode -->
            <!-- Layout API, functionality initialized in Template._uiApiLayout() -->
            <button type="button" class="btn btn-sm btn-alt-secondary" data-toggle="class-toggle" data-target="#dark-mode-toggler" data-class="far fa" onclick="FriezaArmy.layout('dark_mode_toggle');">
      ...
      <div class="content py-0">
        <div class="row fs-sm">
          <div class="col-sm-6 order-sm-2 mb-1 mb-sm-0 text-center text-sm-end">
            Crafted with <i class="fa fa-heart text-danger"></i> by <a class="fw-semibold" href="" target="_blank">Emperor's army</a>
          </div>
          <div class="col-sm-6 order-sm-1 text-center text-sm-start">
            <a class="fw-semibold" href="" target="_blank">Frieza Army</a> &copy;
